...
function displayOneMessage(messageObj, payload, room){
  ...
  var addMessage = {
    ...
    user: {_id:from, name: from}, // todo update with other user name
    createdAt: messageObj.createdAt, // createdAt is generated by AWS
  };
  // room.setState(previousState => ({
  //   messages: GiftedChat.append(previousState.messages, [addMessage]),
  // }));
  room.state.messages = GiftedChat.append(room.state.messages, [addMessage])
...
class ChatScreen extends React.Component {
  ...
  onSend(messages = []) {
    ...
    this.forceUpdate(
      () => {
        //It seems as though the screen does not update without this.
      }
    )
...
////////////////////
  ...
  onReceive = (messageObject) => {
    ...
    var payload = JSON.parse(messageObj.payload);
